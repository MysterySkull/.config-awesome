...
menubar.utils.terminal = apps.term -- Set the terminal for applications that require it
-- }}}
...
awful.rules.rules = {
    ...
    { rule = { },
      properties = { border_width = beautiful.border_width,
                     ...
                     raise = true,
                     keys = require('bindings.client').clientkeys,
                     buttons = require('bindings.client').clientbuttons,
